...
def upgrade() -> None:
    ...
    sa.Column('id', sa.String(length=36), nullable=False, comment='目录唯一标识符'),
    ...
    sa.Column('id', sa.String(length=36), nullable=False, comment='内容顺序标识符'),
    ...
    sa.Column('id', sa.String(length=36), nullable=False, comment='路径顺序标识符'),
    sa.Column('path', sa.Text(), nullable=True, comment='文件路径或来源'),
    sa.Column('embedding', sa.Text(), nullable=True, comment='内容的语义向量，用于相似度搜索等'),
    sa.PrimaryKeyConstraint('id')
    )
