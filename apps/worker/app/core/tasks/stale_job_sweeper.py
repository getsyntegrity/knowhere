...
JOB_EXPIRED_ERROR_MESSAGE = (
    "Job timed out: execution or upload exceeded maximum allowed duration"
)
...
def expire_stale_jobs() -> dict:
    """Expire jobs stuck in non-terminal states beyond ``JOB_EXPIRE_SECONDS``.
