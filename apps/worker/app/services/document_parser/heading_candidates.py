...
from app.services.document_parser.text_helpers import count_cn_en
...
def filter_markdown_headings(
    ...
    if layout_json_path:
        try:
            from app.services.document_parser.metadata_extractor import MetadataContext
...
def _estimate_markdown_heading_level(line: str, meta_ctx: Any | None):
    from app.services.document_parser.metadata_extractor import detect_and_strip_md_bold
