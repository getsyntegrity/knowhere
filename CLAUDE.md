...
- Never push code directly to `staging`.
- Never push code directly to `main`.
- Never create a pull request that targets `main` directly.
- Use non-production branches and non-`main` pull request targets unless the user explicitly changes this rule.
