...
class JobResult(Base):
    ...
    inline_payload: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSON, nullable=True)
    ...
    chunks: Mapped[List["JobChunk"]] = relationship("JobChunk", back_populates="job_result", cascade="all, delete-orphan", lazy="selectin")
...
class JobChunk(Base):
    ...
    def __repr__(self) -> str:
        return f"<JobChunk(chunk_id={self.chunk_id}, job_result_id={self.job_result_id})>"
