...
from sqlalchemy import JSON, DateTime, ForeignKey, BigInteger, String
...
class CreditsTransaction(Base):
    ...
    credits_amount: Mapped[int] = mapped_column(BigInteger, nullable=False)  # In micro-credits: $1.00 = 1,000,000; positive=add, negative=deduct
